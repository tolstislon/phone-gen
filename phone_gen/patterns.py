"""
Auto-generated file 2026-03-17 15:34:31 UTC (v3).
Resource: https://github.com/google/libphonenumber v9.0.26.
"""

PATTERNS = {
    "info": "libphonenumber v9.0.26",
    "data": {
        ...
        "BF": {
            ...
            "mobile": "(?:0[1-7]|44|5[0-8]|[67]\\d)\\d{6}",
        },
        "BG": {
            "code": "359",
        ...
        "CM": {"code": "237", "pattern": "2(?:22|33)\\d{6}", "mobile": "(?:24[23]|6(?:[25-9]\\d|40))\\d{6}"},
        "CN": {
            "code": "86",
        ...
        "GF": {
            "code": "594",
            "pattern": "(?:594(?:[02-49]\\d|1[0-5]|5[6-9]|6[0-3]|80)|80[6-9]\\d\\d)\\d{4}",
        ...
        "GU": {
            ...
            "mobile": "671(?:2\\d\\d|3(?:00|3[39]|4[349]|55|6[26])|4(?:00|56|7[1-9]|8[02-9])|5(?:55|6[2-5]|88)|6(?:3[2-578]|4[24-9]|5[34]|78|8[235-9])|7(?:[0479]7|2[0167]|3[45]|8[7-9])|8(?:[2-57-9]8|6[478])|9(?:2[29]|6[79]|7[1279]|8[7-9]|9[78]))\\d{4}",
        },
        ...
        "IL": {
            ...
            "mobile": "55(?:4(?:0[0-2]|[16]0)|57[0-289])\\d{4}|5(?:(?:[0-2][02-9]|[36]\\d|[49][2-9]|8[3-7])\\d|5(?:01|2\\d|3[0-3]|4[3-5]|5[0-25689]|6[6-8]|7[0-267]|8[7-9]|9[1-9]))\\d{5}",
        },
        "IM": {
            "code": "44",
        ...
        "KE": {
            ...
            "mobile": "(?:1(?:0[0-8]|1\\d|2[014]|[34]0)|7\\d\\d)\\d{6}",
        },
        "KG": {
            "code": "996",
        ...
        "MN": {
            ...
            "mobile": "92[0139]\\d{5}|(?:5[05]|6[069]|7[28]|8[0135689]|9[013-9])\\d{6}",
        },
        "MO": {
            "code": "853",
        ...
        "MY": {
            ...
            "mobile": "1(?:1888[689]|4400|8(?:47|8[27])[0-4])\\d{4}|1(?:0(?:[23568]\\d|4[0-6]|7[016-9]|9[0-8])|1(?:[1-5]\\d\\d|6(?:0[5-9]|[1-9]\\d)|7(?:[0-4]\\d|5[0-79]|6[02-4]))|(?:[269]\\d|[37][1-9]|4[235-9])\\d|5(?:31|9\\d\\d)|8(?:1[23]|[236]\\d|4[06]|5(?:46|[7-9])|7[016-9]|8[01]|9[0-8]))\\d{5}",
        },
        ...
        "TJ": {
            ...
            "mobile": "(?:33[03-9]|4(?:1[18]|4[02-479])|81[1-9])\\d{6}|(?:[09]\\d|1[0-27-9]|2[0-27]|3[08]|40|5[05]|66|7[01578]|8[078])\\d{7}",
        },
