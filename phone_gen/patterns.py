# -*- coding: utf-8 -*-
"""
Auto-generated file 2022-09-24 08:23:35 UTC
Resource: https://github.com/google/libphonenumber v8.12.56
"""


PATTERNS = {
    "info": "libphonenumber v8.12.56",
    "data": {
        "AC": {
            "code": "247",
            "pattern": "((6[2-467][\\d]{3}))",
        ...
        "GF": {
            "code": "594",
            "pattern": "((594([023][\\d])|(1[0-2])|(4[03-9])|(5[6-9])|(6[0-3])|(80)|(9[0-8])[\\d]{4}))",
        ...
        "SG": {
            ...
            "mobile": "((8(05[0-367])|(95[0-2])[\\d]{4})|((8(0[1-4])|([1-8][\\d])|(9[0-4]))|(9[0-8][\\d])[\\d]{5}))",
        },
        "SH": {
            "code": "290",
