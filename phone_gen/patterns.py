"""
Auto-generated file 2025-05-08 07:19:42 UTC (v3).
Resource: https://github.com/google/libphonenumber v9.0.5.
"""

PATTERNS = {
    "info": "libphonenumber v9.0.5",
    "data": {
        ...
        "EH": {
            "code": "212",
            "pattern": "528[89]\\d{5}",
            "mobile": "(?:6(?:[0-79]\\d|8[0-247-9])|7(?:[0167]\\d|2[0-467]|5[0-3]|8[0-7]))\\d{6}",
        },
        "ER": {
            "code": "291",
        ...
        "SG": {
            ...
            "mobile": "897[01]\\d{4}|(?:8(?:0[1-9]|[1-8]\\d|9[0-6])|9[0-8]\\d)\\d{5}",
        },
