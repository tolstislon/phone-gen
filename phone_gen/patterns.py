# -*- coding: utf-8 -*-
"""
Auto-generated file 2021-12-27 20:17:44 UTC
Resource: https://github.com/google/libphonenumber v8.12.40
"""


PATTERNS = {
    "info": "libphonenumber v8.12.40",
    "data": {
        "AC": {
            "code": "247",
            "pattern": "((6[2-467][\\d]{3}))",
        ...
        "EH": {
            "code": "212",
            "pattern": "((528[89][\\d]{5}))",
            "mobile": "(((6([0-79][\\d])|(8[0-247-9]))|(7([01][\\d])|(6[0-367])|(7[0-57]))[\\d]{6}))",
        },
        "ER": {
            "code": "291",
        ...
        "GP": {
            "code": "590",
            "pattern": "((590(0[1-68])|(1[0-24])|(2[0-68])|(3[1289])|(4[0-24-9])|(5[3-579])|(6[0189])|(7[08])|(8[0-689])|(9[\\d])[\\d]{4}))",
            "mobile": "((69(0[\\d][\\d])|(1(2[2-9])|(3[0-5]))[\\d]{4}))",
        },
        "GQ": {
            "code": "240",
        ...
        "HK": {
            ...
            "mobile": "(((46([07][0-7])|(1[0-6])|(4[0-57-9])|(6[0-4]))|(573[0-6])|(6(26[013-8])|(66[0-3]))|(70(7[1-5])|(8[0-4]))|(848[015-9])|(929[03-9])[\\d]{4})|((4(40)|(6[2358]))|(5([1-59][0-46-9])|(6[0-4689])|(7[0-24679]))|(6(0[1-9])|([13-59][\\d])|([268][0-57-9])|(7[0-79]))|(84[09])|(9(0[1-9])|(1[02-9])|([2358][0-8])|([467][\\d]))[\\d]{5}))",
        },
        "HN": {
            "code": "504",
