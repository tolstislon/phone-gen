"""
Auto-generated file 2026-07-03 07:01:58 UTC (v3).
Resource: https://github.com/google/libphonenumber v9.0.34.
"""

PATTERNS = {
    "info": "libphonenumber v9.0.34",
    "data": {
        ...
        "GM": {
            "code": "220",
            "pattern": "(?:4(?:[23]\\d\\d|4(?:1[024679]|[6-9]\\d))|5(?:5(?:3\\d|4[0-7])|6[67]\\d|7(?:1[04]|2[035]|3[58]|48))|8[0-389]\\d\\d)\\d{3}",
            "mobile": "556\\d{4}|(?:[23679]\\d|4[015]|5[0-489]|8[4-7])\\d{5}",
        },
        "GN": {
            "code": "224",
        ...
        "GY": {
            ...
            "mobile": "(?:51[01]|6\\d\\d|7(?:[0-5]\\d|6[0-79]|[78]0))\\d{4}",
        },
        "HK": {
            "code": "852",
        ...
        "KE": {
            ...
            "mobile": "(?:1(?:0[0-8]|1\\d|2[014]|30|4[0-5])|7\\d\\d)\\d{6}",
        },
        "KG": {
            "code": "996",
        ...
        "SJ": {"code": "47", "pattern": "79\\d{6}", "mobile": "[49]\\d{7}"},
        "SK": {
            "code": "421",
        ...
        "TZ": {"code": "255", "pattern": "2[2-8]\\d{7}", "mobile": "(?:6[1-35-9]|7\\d)\\d{7}"},
        "UA": {
            "code": "380",
        ...
        "UG": {
            ...
            "mobile": "7280\\d{5}|7(?:[014-8]\\d|2[01467]|3[016]|9[0-589])\\d{6}",
        },
        "US": {
            "code": "1",
