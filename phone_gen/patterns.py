# -*- coding: utf-8 -*-
"""
Auto-generated file 2023-12-20 09:28:32 UTC
Resource: https://github.com/google/libphonenumber v8.13.27
"""


PATTERNS = {
    "info": "libphonenumber v8.13.27",
    "data": {
        "AC": {
            "code": "247",
            "pattern": "((6[2-467][\\d]{3}))",
        ...
        "HK": {
            ...
            "mobile": "(((4(44[5-9])|(6(1[0-7])|(4[0-57-9])|(6[0-4])))|(5(73[0-6])|(95[0-8]))|(6(26[013-8])|(66[0-3]))|(70(7[1-6])|(8[0-4]))|(848[0-25-9])|(9(29[013-9])|(59[0-4])|(899))[\\d]{4})|((4(4[0156])|(6[02357-9]))|(5([1-59][0-46-9])|(6[0-4689])|(7[0-246-9]))|(6(0[1-9])|([13-59][\\d])|([268][0-57-9])|(7[0-79]))|(709)|(84[09])|(9(0[1-9])|(1[02-9])|([2358][0-8])|([467][\\d]))[\\d]{5}))",
        },
        "HN": {
            "code": "504",
        ...
        "SG": {
            ...
            "mobile": "((8(08[013-9])|(95[0-2])[\\d]{4})|((8(0[1-7])|([1-8][\\d])|(9[0-4]))|(9[0-8][\\d])[\\d]{5}))",
        },
        "SH": {
            "code": "290",
        ...
        "US": {
            ...
            "mobile": "(((5056([0-35-9][\\d])|(4[468]))|(73020[\\d])[\\d]{4})|((472[24])|(505[2-57-9])|(983[289])[\\d]{6})|((2(0[1-35-9])|(1[02-9])|(2[03-57-9])|(3[149])|(4[08])|(5[1-46])|(6[0279])|(7[0269])|(8[13]))|(3(0[1-57-9])|(1[02-9])|(2[013569])|(3[0-24679])|(4[167])|(5[0-2])|(6[0149])|(8[056]))|(4(0[124-9])|(1[02-579])|(2[3-5])|(3[0245])|(4[023578])|(58)|(6[349])|(7[0589])|(8[04]))|(5(0[1-47-9])|(1[0235-8])|(20)|(3[0149])|(4[01])|(5[179])|(6[1-47])|(7[0-5])|(8[0256]))|(6(0[1-35-9])|(1[024-9])|(2[03689])|([34][016])|(5[01679])|(6[0-279])|(78)|(8[0-29]))|(7(0[1-46-8])|(1[2-9])|(2[04-7])|(3[1247])|(4[037])|(5[47])|(6[02359])|(7[0-59])|(8[156]))|(8(0[1-68])|(1[02-8])|(2[068])|(3[0-2589])|(4[03578])|(5[046-9])|(6[02-5])|(7[028]))|(9(0[1346-9])|(1[02-9])|(2[0589])|(3[0146-8])|(4[01357-9])|(5[12469])|(7[0-389])|(8[04-69]))[2-9][\\d]{6}))",
        },
        "UY": {
            "code": "598",
