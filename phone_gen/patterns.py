...
PATTERNS = {
    ...
    "data": {
        ...
        "HK": {
            ...
            "mobile": "(((4(44[05-9])|(6(1[0-7])|(4[0-57-9])|(6[0-4])))|(5(73[0-6])|(95[0-8]))|(6(26[013-8])|(66[0-3]))|(70(7[1-6])|(8[0-4]))|(848[0-35-9])|(9(29[013-9])|(39[01])|(59[0-4])|(899))[\\d]{4})|((4(4[015-8])|(6[02357-9]))|(5([1-59][0-46-9])|(6[0-4689])|(7[0-246-9]))|(6(0[1-9])|([13-59][\\d])|([268][0-57-9])|(7[0-79]))|(70[129])|(84[09])|(9(0[1-9])|(1[02-9])|([2358][0-8])|([467][\\d]))[\\d]{5}))",
        },
        "HN": {
            "code": "504",
        ...
        "LI": {
            ...
            "mobile": "(((6((4[5-9])|(5[0-469])[\\d])|(6([0245][\\d])|([17]0)|(3[7-9]))[\\d])|(7([37-9][\\d])|(42)|(56))[\\d]{4}))",
        },
        "LK": {
            "code": "94",
        ...
        "OM": {
            "code": "968",
            "pattern": "((2[1-6][\\d]{6}))",
            "mobile": "((1505[\\d]{4})|((7([1289][\\d])|(6[89])|(7[0-5]))|(9(0[1-9])|([1-9][\\d]))[\\d]{5}))",
        },
        "PA": {
            "code": "507",
        ...
        "PL": {
            ...
            "mobile": "((21(1([145][\\d])|(3[1-5]))|(2[\\d][\\d])[\\d]{4})|((45)|(5[0137])|(6[069])|(7[2389])|(88)[\\d]{7}))",
        },
        "PM": {
            "code": "508",
        ...
        "US": {
            ...
            "mobile": "(((5056([0-35-9][\\d])|(4[468]))|(7302[01][\\d])[\\d]{4})|((472[24])|(505[2-57-9])|(983[289])[\\d]{6})|((2(0[1-35-9])|(1[02-9])|(2[03-57-9])|(3[149])|(4[08])|(5[1-46])|(6[0279])|(7[0269])|(8[13]))|(3(0[1-57-9])|(1[02-9])|(2[013569])|(3[0-24679])|(4[167])|(5[0-2])|(6[0149])|(8[056]))|(4(0[124-9])|(1[02-579])|(2[3-5])|(3[0245])|(4[023578])|(58)|(6[349])|(7[0589])|(8[04]))|(5(0[1-47-9])|(1[0235-8])|(20)|(3[0149])|(4[01])|(5[179])|(6[1-47])|(7[0-5])|(8[0256]))|(6(0[1-35-9])|(1[024-9])|(2[03689])|(3[016])|(4[0156])|(5[01679])|(6[0-279])|(78)|(8[0-29]))|(7(0[1-46-8])|(1[2-9])|(2[04-7])|(3[1247])|(4[037])|(5[47])|(6[02359])|(7[0-59])|(8[156]))|(8(0[1-68])|(1[02-8])|(2[068])|(3[0-2589])|(4[03578])|(5[046-9])|(6[02-5])|(7[028]))|(9(0[1346-9])|(1[02-9])|(2[0589])|(3[0146-8])|(4[01357-9])|(5[12469])|(7[0-389])|(8[04-69]))[2-9][\\d]{6}))",
        },
        "UY": {
            "code": "598",
