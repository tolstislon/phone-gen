# -*- coding: utf-8 -*-
"""
Auto-generated file 2024-11-19 13:34:58 UTC (v3)
Resource: https://github.com/google/libphonenumber v8.13.50
"""


PATTERNS = {
    "info": "libphonenumber v8.13.50",
    "data": {
        ...
        "HK": {
            ...
            "mobile": "(?:4(?:44[0-25-9]|6(?:1[0-7]|4[0-57-9]|6[0-4])|74[0-2])|5(?:73[0-6]|95[0-8])|6(?:26[013-8]|66[0-3])|70(?:7[1-8]|8[0-4])|84(?:4[0-2]|8[0-35-9])|9(?:29[013-9]|39[01]|59[0-4]|899))\\d{4}|(?:4(?:4[0-35-9]|6[02357-9]|7[05])|5(?:[1-59][0-46-9]|6[0-4689]|7[0-246-9])|6(?:0[1-9]|[13-59]\\d|[268][0-57-9]|7[0-79])|70[1-49]|84[0-39]|9(?:0[1-9]|1[02-9]|[2358][0-8]|[467]\\d))\\d{5}",
        },
        "HN": {
            "code": "504",
        ...
        "SN": {
            ...
            "mobile": "7(?:(?:[06-8]\\d|[19]0|21)\\d|5(?:0[01]|[19]0|2[25]|[38]3|[4-7]\\d))\\d{5}",
        },
        "SO": {
            "code": "252",
