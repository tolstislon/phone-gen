...
PATTERNS = {
    ...
    "data": {
        ...
        "CZ": {
            ...
            "mobile": "(?:60[1-8]\\d|7(?:0(?:[2-5]\\d|60)|190|[2379]\\d\\d))\\d{5}",
        },
        "DE": {
            "code": "49",
        ...
        "IL": {
            ...
            "mobile": "55(?:410|57[0-289])\\d{4}|5(?:(?:[02][02-9]|[149][2-9]|[36]\\d|8[3-7])\\d|5(?:01|2\\d|3[0-3]|4[34]|5[0-25689]|6[6-8]|7[0-267]|8[7-9]|9[1-9]))\\d{5}",
        },
        "IM": {
            "code": "44",
