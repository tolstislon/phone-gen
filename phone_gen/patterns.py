# -*- coding: utf-8 -*-
"""
Auto-generated file 2022-12-15 15:08:17 UTC
Resource: https://github.com/google/libphonenumber v8.13.2
"""


PATTERNS = {
    "info": "libphonenumber v8.13.2",
    "data": {
        "AC": {
            "code": "247",
            "pattern": "((6[2-467][\\d]{3}))",
        ...
        "SG": {
            ...
            "mobile": "(((8(0([1-4][\\d])|(5[0-8])|(6[0-6]))|([1-8][\\d][\\d])|(9([0-4][\\d])|(5[0-2])))|(9[0-8][\\d][\\d])[\\d]{4}))",
        },
        "SH": {
            "code": "290",
