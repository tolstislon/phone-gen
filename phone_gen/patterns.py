# -*- coding: utf-8 -*-
"""
Auto-generated file 2022-12-27 13:27:39 UTC
Resource: https://github.com/google/libphonenumber v8.13.3
"""


PATTERNS = {
    "info": "libphonenumber v8.13.3",
    "data": {
        "AC": {
            "code": "247",
            "pattern": "((6[2-467][\\d]{3}))",
        ...
        "GH": {
            ...
            "mobile": "(((2([0346-9][\\d])|(5[67]))|(5([04-7][\\d])|(9[1-9]))[\\d]{6}))",
        },
        "GI": {
            "code": "350",
        ...
        "QA": {
            "code": "974",
            "pattern": "((4(1111)|(2022)[\\d]{3})|((23[\\d][\\d])|(4([04][\\d][\\d])|(14[0-6])|(999))[\\d]{4}))",
