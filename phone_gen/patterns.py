"""
Auto-generated file 2026-05-26 11:29:01 UTC (v3).
Resource: https://github.com/google/libphonenumber v9.0.31.
"""

PATTERNS = {
    "info": "libphonenumber v9.0.31",
    "data": {
        ...
        "DZ": {
            ...
            "mobile": "5(?:4[0-29]|6[0-3])\\d{6}|(?:55|6\\d|7[7-9])\\d{7}",
        },
        "EC": {
            "code": "593",
            "pattern": "[2-7][2-7]\\d{6}",
        ...
        "SG": {
            ...
            "mobile": "898[02-9]\\d{4}|(?:8(?:0[1-9]|[1-8]\\d|9[0-79])|9[0-8]\\d)\\d{5}",
        },
        ...
        "UG": {
            ...
            "mobile": "72[48]0\\d{5}|7(?:[014-8]\\d|2[0167]|3[06]|9[0-589])\\d{6}",
        },
        "US": {
            "code": "1",
