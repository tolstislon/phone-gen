# -*- coding: utf-8 -*-
"""
Auto-generated file 2024-07-26 17:24:22 UTC (v3)
Resource: https://github.com/google/libphonenumber v8.13.42
"""


PATTERNS = {
    "info": "libphonenumber v8.13.42",
    "data": {
        ...
        "AO": {"code": "244", "pattern": "2\\d(?:[0134][25-9]|[25-9]\\d)\\d{5}", "mobile": "9[1-579]\\d{7}"},
        "AR": {
            "code": "54",
        ...
        "CM": {"code": "237", "pattern": "2(?:22|33)\\d{6}", "mobile": "(?:24[23]|6[25-9]\\d)\\d{6}"},
        "CN": {
            "code": "86",
        ...
        "DE": {
            ...
            "mobile": "15(?:[0-25-9]\\d\\d|310)\\d{6}|1(?:6[023]|7\\d)\\d{7,8}",
        },
        ...
        "HK": {
            ...
            "mobile": "(?:4(?:44[0-25-9]|6(?:1[0-7]|4[0-57-9]|6[0-4]))|5(?:73[0-6]|95[0-8])|6(?:26[013-8]|66[0-3])|70(?:7[1-8]|8[0-4])|848[0-35-9]|9(?:29[013-9]|39[01]|59[0-4]|899))\\d{4}|(?:4(?:4[0-35-8]|6[02357-9]|70)|5(?:[1-59][0-46-9]|6[0-4689]|7[0-246-9])|6(?:0[1-9]|[13-59]\\d|[268][0-57-9]|7[0-79])|70[1-39]|84[0-29]|9(?:0[1-9]|1[02-9]|[2358][0-8]|[467]\\d))\\d{5}",
        },
        "HN": {
            "code": "504",
