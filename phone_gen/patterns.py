"""
Auto-generated file 2025-05-02 07:20:31 UTC (v3).
Resource: https://github.com/google/libphonenumber v9.0.4.
"""

PATTERNS = {
    "info": "libphonenumber v9.0.4",
    "data": {
        ...
        "BI": {"code": "257", "pattern": "(?:22|31)\\d{6}", "mobile": "64[0-2]\\d{5}|(?:29|[67][125-9])\\d{6}"},
        "BJ": {
            "code": "229",
        ...
        "LB": {
            ...
            "mobile": "787\\d{4}|(?:(?:3|81)\\d|7(?:[01]\\d|6[013-9]|8[89]|9[1-3]))\\d{5}",
        },
        "LC": {
            "code": "1",
        ...
        "SG": {
            ...
            "mobile": "8970\\d{4}|(?:8(?:0[1-9]|[1-8]\\d|9[0-6])|9[0-8]\\d)\\d{5}",
        },
