"""
Auto-generated file 2025-08-19 07:33:33 UTC (v3).
Resource: https://github.com/google/libphonenumber v9.0.12.
"""

PATTERNS = {
    "info": "libphonenumber v9.0.12",
    "data": {
        ...
        "AU": {
            ...
            "mobile": "4(?:79[01]|83[0-389]|94[0-478])\\d{5}|4(?:[0-36]\\d|4[047-9]|[58][0-24-9]|7[02-8]|9[0-37-9])\\d{6}",
        },
        "AW": {
            "code": "297",
        ...
        "BR": {
            ...
            "mobile": "(?:1[1-9]|2[12478]|3[13-5]|4[1-9]|5[1-5]|6[1-9]|7[1-9]|8[1-9]|9[1-9])9\\d{8}",
        },
        "BS": {
            "code": "1",
        ...
        "CL": {
            ...
            "mobile": "2(?:1982[0-6]|3314[05-9])\\d{3}|(?:2(?:1(?:160|962)|2\\d{3}|3(?:(?:2\\d|50)\\d|3(?:[03467]\\d|1[0-35-9]|2[1-9]|5[0-24-9]|8[0-389]|9[0-8])|600)|646[59])|(?:(?:3[2-5]|[47][1-35]|5[1-3578]|6[13-57])\\d|8(?:0[1-8]|[1-9]\\d))\\d\\d|9(?:(?:10[01]|(?:[2458]\\d|7[1-9])\\d)\\d|3(?:[0-57-9]\\d\\d|6(?:0[02-9]|[1-9]\\d))|6(?:[0-8]\\d\\d|9(?:[02-79]\\d|1[05-9]))|9(?:[03-9]\\d\\d|1(?:[0235-9]\\d|4[0-24-9])|2(?:[0-79]\\d|8[0-46-9]))))\\d{4}",
        },
        ...
        "CZ": {
            ...
            "mobile": "(?:60[1-8]\\d|7(?:0(?:[2-5]\\d|60)|19[0-4]|[2379]\\d\\d))\\d{5}",
        },
        "DE": {
            "code": "49",
        ...
        "EH": {
            "code": "212",
            "pattern": "528[89]\\d{5}",
            "mobile": "(?:6(?:[0-79]\\d|8[0-247-9])|7(?:[0167]\\d|2[0-8]|5[0-5]|8[0-7]))\\d{6}",
        },
        "ER": {
            "code": "291",
        ...
        "GY": {
            ...
            "mobile": "(?:51[01]|6\\d\\d|7(?:[0-5]\\d|6[019]|70))\\d{4}",
        },
        "HK": {
            "code": "852",
            "pattern": "(?:2(?:[13-9]\\d|2[013-9])\\d|3(?:(?:[1569][0-24-9]|4[0-246-9]|7[0-24-69])\\d|8(?:4[0-8]|[579]\\d|6[0-5]))|58(?:0[1-9]|1[2-9]))\\d{4}",
            "mobile": "(?:4(?:44[0-35-9]|6(?:4[0-57-9]|6[0-4])|7(?:3[0-4]|4[0-48]|6[0-5]))|5(?:35[4-8]|73[0-6]|95[0-8])|6(?:26[013-8]|(?:66|78)[0-5])|70(?:7[1-8]|8[0-8])|84(?:4[0-2]|8[0-35-9])|9(?:29[013-9]|39[014-9]|59[0-4]|899))\\d{4}|(?:4(?:4[0-35-9]|6[0-357-9]|7[0-25])|5(?:[1-59][0-46-9]|6[0-4689]|7[0-246-9])|6(?:0[1-9]|[13-59]\\d|[268][0-57-9]|7[0-79])|70[1-59]|84[0-39]|9(?:0[1-9]|1[02-9]|[2358][0-8]|[467]\\d))\\d{5}",
        },
        "HN": {
            "code": "504",
        ...
        "IL": {
            ...
            "mobile": "55(?:4(?:[01]0|5[0-5])|57[0-289])\\d{4}|5(?:(?:[0-2][02-9]|[36]\\d|[49][2-9]|8[3-7])\\d|5(?:01|2\\d|3[0-3]|4[34]|5[0-25689]|6[6-8]|7[0-267]|8[7-9]|9[1-9]))\\d{5}",
        },
        "IM": {
            "code": "44",
        ...
        "OM": {
            "code": "968",
            "pattern": "2[1-6]\\d{6}",
            "mobile": "1505\\d{4}|(?:7(?:[126-9]\\d|41)|9(?:0[1-9]|[1-9]\\d))\\d{5}",
        },
        "PA": {
            "code": "507",
        ...
        "SG": {
            ...
            "mobile": "89(?:7[0-689]|80)\\d{4}|(?:8(?:0[1-9]|[1-8]\\d|9[0-6])|9[0-8]\\d)\\d{5}",
        },
        ...
        "TD": {"code": "235", "pattern": "22(?:[37-9]0|5[0-5]|6[89])\\d{4}", "mobile": "(?:30|[69]\\d|77|8[56])\\d{6}"},
        "TG": {
            "code": "228",
