# -*- coding: utf-8 -*-
"""
Auto-generated file 2023-04-19 13:07:56 UTC
Resource: https://github.com/google/libphonenumber v8.13.10
"""


PATTERNS = {
    "info": "libphonenumber v8.13.10",
    "data": {
        "AC": {
            "code": "247",
            "pattern": "((6[2-467][\\d]{3}))",
        ...
        "RE": {
            ...
            "mobile": "(((69(2[\\d][\\d])|(3(0[0-46])|(1[013])|(2[0-2])|(3[0-39])|(4[\\d])|(5[0-5])|(6[0-6])|(7[0-27])|(8[0-8])|(9[0-479])))|(9(399[0-2])|(479[01])|(76(2[27])|(3[0-37])|(9[\\d])))[\\d]{4}))",
        },
        "RO": {
            "code": "40",
        ...
        "US": {
            ...
            "mobile": "(((4722(0[0-35])|(27))|(505([2-57-9][\\d][\\d])|(6([0-35-9][\\d])|(4[46])))[\\d]{4})|((2(0[1-35-9])|(1[02-9])|(2[03-589])|(3[149])|(4[08])|(5[1-46])|(6[0279])|(7[0269])|(8[13]))|(3(0[1-57-9])|(1[02-9])|(2[01356])|(3[0-24679])|(4[167])|(5[0-2])|(6[014])|(8[056]))|(4(0[124-9])|(1[02-579])|(2[3-5])|(3[0245])|(4[023578])|(58)|(6[349])|(7[0589])|(8[04]))|(5(0[1-47-9])|(1[0235-8])|(20)|(3[0149])|(4[01])|(5[179])|(6[1-47])|(7[0-5])|(8[0256]))|(6(0[1-35-9])|(1[024-9])|(2[03689])|([34][016])|(5[01679])|(6[0-279])|(78)|(8[0-29]))|(7(0[1-46-8])|(1[2-9])|(2[04-7])|(3[1247])|(4[037])|(5[47])|(6[02359])|(7[0-59])|(8[156]))|(8(0[1-68])|(1[02-8])|(2[068])|(3[0-2589])|(4[03578])|(5[046-9])|(6[02-5])|(7[028]))|(9(0[1346-9])|(1[02-9])|(2[0589])|(3[0146-8])|(4[01357-9])|(5[12469])|(7[0-389])|(8[04-69]))[2-9][\\d]{6}))",
        },
        "UY": {
            "code": "598",
