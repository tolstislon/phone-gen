# -*- coding: utf-8 -*-
"""
Auto-generated file 2024-02-09 15:17:42 UTC
Resource: https://github.com/google/libphonenumber v8.13.30
"""


PATTERNS = {
    "info": "libphonenumber v8.13.30",
    "data": {
        "AC": {
            "code": "247",
            "pattern": "((6[2-467][\\d]{3}))",
        ...
        "BM": {
            ...
            "mobile": "((441909[\\d]{4})|(441([2378][\\d])|(5[0-39])|(92)[\\d]{5}))",
        },
        "BN": {
            "code": "673",
        ...
        "GY": {
            ...
            "mobile": "(((510)|(6[\\d][\\d])|(7([01][\\d])|(2[156])|(49))[\\d]{4}))",
        },
        "HK": {
            "code": "852",
        ...
        "NG": {
            ...
            "mobile": "(((702[0-24-9])|(819[01])[\\d]{6})|((7(0[13-689])|([12][\\d]))|(8(0[1-9])|(1[0-8]))|(9(0[1-9])|(1[1-6]))[\\d]{7}))",
        },
        "NI": {
            "code": "505",
            "pattern": "((2[\\d]{7}))",
        ...
        "OM": {
            "code": "968",
            "pattern": "((2[1-6][\\d]{6}))",
            "mobile": "((1505[\\d]{4})|((7([1289][\\d])|(6[7-9])|(7[0-5]))|(9(0[1-9])|([1-9][\\d]))[\\d]{5}))",
        },
        "PA": {
            "code": "507",
        ...
        "SG": {
            ...
            "mobile": "((895[0-2][\\d]{4})|((8(0[1-8])|([1-8][\\d])|(9[0-4]))|(9[0-8][\\d])[\\d]{5}))",
        },
        "SH": {
            "code": "290",
        ...
        "US": {
            ...
            "mobile": "(((5056([0-35-9][\\d])|(4[468]))|(7302[0-3][\\d])[\\d]{4})|((472[24])|(505[2-57-9])|(7306)|(983[237-9])[\\d]{6})|((2(0[1-35-9])|(1[02-9])|(2[03-57-9])|(3[149])|(4[08])|(5[1-46])|(6[0279])|(7[0269])|(8[13]))|(3(0[1-57-9])|(1[02-9])|(2[013569])|(3[0-24679])|(4[167])|(5[0-2])|(6[01349])|(8[056]))|(4(0[124-9])|(1[02-579])|(2[3-5])|(3[0245])|(4[023578])|(58)|(6[349])|(7[0589])|(8[04]))|(5(0[1-47-9])|(1[0235-8])|(20)|(3[0149])|(4[01])|(5[179])|(6[1-47])|(7[0-5])|(8[0256]))|(6(0[1-35-9])|(1[024-9])|(2[03689])|(3[016])|(4[0156])|(5[01679])|(6[0-279])|(78)|(8[0-29]))|(7(0[1-46-8])|(1[2-9])|(2[04-7])|(3[1247])|(4[037])|(5[47])|(6[02359])|(7[0-59])|(8[156]))|(8(0[1-68])|(1[02-8])|(2[068])|(3[0-2589])|(4[03578])|(5[046-9])|(6[02-5])|(7[028]))|(9(0[1346-9])|(1[02-9])|(2[0589])|(3[0146-8])|(4[01357-9])|(5[12469])|(7[0-389])|(8[04-69]))[2-9][\\d]{6}))",
        },
        "UY": {
            "code": "598",
