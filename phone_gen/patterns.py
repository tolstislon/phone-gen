# -*- coding: utf-8 -*-
"""
Auto-generated file 2023-01-29 11:39:34 UTC
Resource: https://github.com/google/libphonenumber v8.13.5
"""


PATTERNS = {
    "info": "libphonenumber v8.13.5",
    "data": {
        "AC": {
            "code": "247",
            "pattern": "((6[2-467][\\d]{3}))",
        ...
        "GI": {
            "code": "350",
            "pattern": "((2190[0-2][\\d]{3})|(2(0(0[\\d])|(20))|(16[24-9])|(2[2-5][\\d])[\\d]{4}))",
        ...
        "GP": {
            "code": "590",
            "pattern": "((590(0[1-68])|([14][0-24-9])|(2[0-68])|(3[1289])|(5[3-579])|(6[0-489])|(7[08])|(8[0-689])|(9[\\d])[\\d]{4}))",
            "mobile": "((69(0[\\d][\\d])|(1(2[2-9])|(3[0-5]))[\\d]{4}))",
        },
        "GQ": {
            "code": "240",
