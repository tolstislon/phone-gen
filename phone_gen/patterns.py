# -*- coding: utf-8 -*-
"""
Auto-generated file 2023-09-22 16:02:47 UTC
Resource: https://github.com/google/libphonenumber v8.13.21
"""


PATTERNS = {
    "info": "libphonenumber v8.13.21",
    "data": {
        "AC": {
            "code": "247",
            "pattern": "((6[2-467][\\d]{3}))",
        ...
        "IL": {
            ...
            "mobile": "((55410[\\d]{4})|(5(([02][02-9])|([149][2-9])|([36][\\d])|(8[3-7])[\\d])|(5(01)|(2[2-9])|(3[0-3])|(4[34])|(5[0-25689])|(6[6-8])|(7[0-267])|(8[7-9])|(9[1-9]))[\\d]{5}))",
        },
        "IM": {
            "code": "44",
