...
PATTERNS = {
    ...
    "data": {
        ...
        "AL": {
            "code": "355",
            "pattern": "((([2358][16-9][\\d][2-9])|(4410)[\\d]{4})|(([2358][2-5][2-9])|(4([2-57-9][2-9])|(6[\\d]))[\\d]{5}))",
        },
        "AM": {
            "code": "374",
        ...
        "CL": {
            "code": "56",
            "pattern": "((2(1982[0-6])|(3314[05-9])[\\d]{3})|((2(1(160)|(962))|(3(2[\\d][\\d])|(3(0[\\d])|(1[0-35-9])|(2[1-9])|(3[0-2])|(40))))|(80[1-9][\\d][\\d])|(9(3([0-57-9][\\d][\\d])|(6(0[02-9])|([1-9][\\d])))|(6([0-8][\\d][\\d])|(9([02-79][\\d])|(1[05-9])))|(7[1-9][\\d][\\d])|(9([03-9][\\d][\\d])|(1([0235-9][\\d])|(4[0-24-9]))|(2([0-79][\\d])|(8[0-46-9]))))[\\d]{4})|((22)|(3[2-5])|([47][1-35])|(5[1-3578])|(6[13-57])|(8[1-9])|(9[2458])[\\d]{7}))",
        },
        ...
        "HN": {
            "code": "504",
            "pattern": "((2(2(0[0139])|(1[1-36])|([23][\\d])|(4[04-6])|(5[57])|(6[24])|(7[0135689])|(8[01346-9])|(9[0-2]))|(4(07)|(2[3-59])|(3[13-689])|(4[0-68])|(5[1-35]))|(5(0[78])|(16)|(4[03-5])|(5[\\d])|(6[014-6])|(74)|(80))|(6([056][\\d])|(17)|(2[07])|(3[04])|(4[0-378])|([78][0-8])|(9[01]))|(7(6[46-9])|(7[02-9])|(8[034])|(91))|(8(79)|(8[0-357-9])|(9[1-57-9]))[\\d]{4}))",
        },
        "HR": {
            "code": "385",
        ...
        "JM": {
            "code": "1",
            "pattern": "(((658(2([0-8][\\d])|(9[0-46-9]))|([3-9][\\d][\\d]))|(876(5(02)|(1[0-468])|(2[35])|(63))|(6(0[1-3579])|(1[0237-9])|([23][\\d])|(40)|(5[06])|(6[2-589])|(7[05])|(8[04])|(9[4-9]))|(7(0[2-689])|([1-6][\\d])|(8[056])|(9[45]))|(9(0[1-8])|(1[02378])|([2-8][\\d])|(9[2-468])))[\\d]{4}))",
        },
        "JO": {
            "code": "962",
