"""
Auto-generated file 2026-08-31 07:41:21 UTC (v3).
Resource: https://github.com/google/libphonenumber v9.0.38.
"""

PATTERNS = {
    "info": "libphonenumber v9.0.38",
    "data": {
        "AC": {"code": "247", "pattern": "6\\d{4}", "mobile": "[2-47]\\d{4}"},
        "AD": {"code": "376", "pattern": "[78]\\d{5}", "mobile": "690\\d{6}|[356]\\d{5}"},
        "AE": {"code": "971", "pattern": "[2-4679][2-8]\\d{6}", "mobile": "5[02-68]\\d{7}"},
        "AF": {"code": "93", "pattern": "(?:[25][0-8]|[34][0-4]|6[0-5])[2-9]\\d{6}", "mobile": "7\\d{8}"},
        "AG": {
            "code": "1",
        ...
        "AI": {
            ...
            "mobile": "264(?:235|4(?:69|7[67])|5(?:3[6-9]|8[1-4])|7(?:29|72))\\d{4}",
        },
        "AL": {
            "code": "355",
        ...
        "AO": {"code": "244", "pattern": "2\\d(?:[0134][25-9]|[25-9]\\d)\\d{5}", "mobile": "9[1-79]\\d{7}"},
        "AR": {
            "code": "54",
        ...
        "AS": {
            "code": "1",
            "pattern": "684(?:274|6(?:22|33|44|55|77|88|9[19]))\\d{4}",
            "mobile": "684(?:2(?:48|5[2468]|7[246])|7(?:3[13]|70|82))\\d{4}",
        },
        "AT": {
            "code": "43",
        ...
        "AX": {"code": "358", "pattern": "18[1-8]\\d{3,6}", "mobile": "4946\\d{2,6}|(?:4[0-8]|50)\\d{4,8}"},
        "AZ": {
            "code": "994",
        ...
        "BF": {
            "code": "226",
            "pattern": "2(?:0(?:49|5[23]|6[5-7]|9[016-9])|4(?:4[569]|5[4-6]|6[5-7]|7[0179])|5(?:[34]\\d|50|6[5-8]))\\d{4}",
            "mobile": "(?:0[1-7]|4[4-6]|5[0-8]|[67]\\d)\\d{6}",
        },
        "BG": {
            "code": "359",
        ...
        "BI": {"code": "257", "pattern": "(?:22|31)\\d{6}", "mobile": "(?:29|6[1-9]|7[125-9])\\d{6}"},
        "BJ": {"code": "229", "pattern": "012\\d{7}", "mobile": "01(?:2[5-9]|[4-69]\\d)\\d{6}"},
        "BL": {
            "code": "590",
            "pattern": "(?:59(?:0(?:2[7-9]|3[3-7]|5[12]|87)|87\\d)|80[6-9]\\d\\d)\\d{4}",
            "mobile": "(?:69(?:0\\d\\d|1(?:2[2-9]|3[0-5]))|7090[0-4])\\d{4}",
        },
        "BM": {
            "code": "1",
            "pattern": "441(?:[46]\\d\\d|5(?:4\\d|60|89))\\d{4}",
            "mobile": "441(?:[2378]\\d|5[0-39]|9[02])\\d{5}",
        },
        "BN": {
            "code": "673",
        ...
        "CD": {
            ...
            "mobile": "88\\d{5}|(?:8[0-69]|9[016-9])\\d{7}",
        },
        "CF": {"code": "236", "pattern": "(?:2[12]|61)\\d{6}", "mobile": "7[02-7]\\d{6}"},
        "CG": {
            "code": "242",
        ...
        "CK": {"code": "682", "pattern": "(?:2\\d|3[13-7]|4[1-5])\\d{3}", "mobile": "[578]\\d{4}"},
        "CL": {
            "code": "56",
            "pattern": "2(?:1982[0-6]|3314[05-9])\\d{3}|(?:2(?:1(?:160|962)|3(?:(?:[24]\\d|50)\\d|3(?:[0346-9]\\d|1[0-35-9]|2[1-9]|5[0-24-9])|600)|646[59])|(?:600|80[1-9])\\d\\d|9(?:(?:10[0-2]|7[1-9]\\d)\\d|3(?:[0-57-9]\\d\\d|6(?:0[02-9]|[1-9]\\d))|6(?:[0-8]\\d\\d|9(?:[02-79]\\d|1[05-9]))|9(?:[03-9]\\d\\d|1(?:[0235-9]\\d|4[0-24-9])|2(?:[0-79]\\d|8[0-46-9]))))\\d{4}|(?:22|3[2-5]|[47][1-35]|5[1-3578]|6[13-57]|8[1-9]|9[2458])\\d{7}",
            "mobile": "2(?:1982[0-6]|3314[05-9])\\d{3}|(?:2(?:1(?:160|962)|3(?:(?:[24]\\d|50)\\d|3(?:[0346-9]\\d|1[0-35-9]|2[1-9]|5[0-24-9])|600)|646[59])|80[1-8]\\d\\d|9(?:(?:10[0-2]|7[1-9]\\d)\\d|3(?:[0-57-9]\\d\\d|6(?:0[02-9]|[1-9]\\d))|6(?:[0-8]\\d\\d|9(?:[02-79]\\d|1[05-9]))|9(?:[03-9]\\d\\d|1(?:[0235-9]\\d|4[0-24-9])|2(?:[0-79]\\d|8[0-46-9]))))\\d{4}|(?:22|3[2-5]|[47][1-35]|5[1-3578]|6[13-57]|8[1-9]|9[2458])\\d{7}",
        },
        "CM": {"code": "237", "pattern": "2(?:22|33)\\d{6}", "mobile": "(?:24[23]|6(?:[25-9]\\d|4[0-2]))\\d{6}"},
        "CN": {
            "code": "86",
        ...
        "CY": {"code": "357", "pattern": "2[2-6]\\d{6}", "mobile": "9(?:10|[4-79]\\d)\\d{5}"},
        "CZ": {
            "code": "420",
            "pattern": "(?:2\\d|3[1257-9]|4[16-9]|5[13-9])\\d{7}",
            "mobile": "7060\\d{5}|(?:60[1-8]|7(?:0[2-5]|19|[2379]\\d))\\d{6}",
        },
        "DE": {
            "code": "49",
            "pattern": "32\\d{9,11}|49[1-6]\\d{10}|322\\d{6}|49[0-7]\\d{3,9}|(?:[34]0|[68]9)\\d{3,13}|(?:2(?:0[1-689]|[1-3569]\\d|4[0-8]|7[1-7]|8[0-7])|3(?:[3569]\\d|4[0-79]|7[1-7]|8[1-8])|4(?:1[02-9]|[2-48]\\d|5[0-6]|6[0-8]|7[0-79])|5(?:0[2-8]|[124-6]\\d|[38][0-8]|[79][0-7])|6(?:0[02-9]|[1-358]\\d|[47][0-8]|6[1-9])|7(?:0[2-8]|1[1-9]|[27][0-7]|3\\d|[4-6][0-8]|8[0-5]|9[013-7])|8(?:0[2-9]|1[0-79]|2\\d|3[0-46-9]|4[0-6]|5[013-9]|6[1-8]|7[0-8]|8[0-24-6])|9(?:0[6-9]|[1-4]\\d|[589][0-7]|6[0-8]|7[0-467]))\\d{3,12}",
            "mobile": "1(?:6[023]|7\\d)\\d{7,8}|15(?:[0-25-9]\\d\\d|3(?:10|33))\\d{6}",
        },
        ...
        "DZ": {
            "code": "213",
            "pattern": "9619\\d{5}|(?:[1-3]\\d|4[013-689])\\d{6}",
            "mobile": "5(?:4[0-29]|6[0-4])\\d{6}|(?:55|6\\d|7[7-9])\\d{7}",
        },
        "EC": {
            "code": "593",
            "pattern": "[2-7][2-7]\\d{6}",
        ...
        "EH": {
            "code": "212",
            "pattern": "528[89]\\d{5}",
            "mobile": "(?:6(?:[0-79]\\d|8[0-247-9])|7(?:[016-8]\\d|2[0-8]|3[01]|5[0-5]))\\d{6}",
        },
        "ER": {
            "code": "291",
        ...
        "ES": {
            "code": "34",
            "pattern": "96906(?:0[0-8]|1[1-9]|[2-9]\\d)\\d\\d|9(?:69(?:0[0-57-9]|[1-9]\\d)|73(?:[0-8]\\d|9[1-9]))\\d{4}|(?:400|8(?:[1356]\\d|[28][0-8]|[47][1-9])|9(?:[135]\\d|[268][0-8]|4[1-9]|7[124-9]))\\d{6}",
        ...
        "FJ": {
            "code": "679",
            "pattern": "603\\d{4}|(?:3[0-6]|6[25-7]|8[58])\\d{5}",
            "mobile": "(?:[279]\\d|45|5[01568]|8[034679])\\d{5}",
        },
        "FK": {"code": "500", "pattern": "[2-47]\\d{4}", "mobile": "[56]\\d{4}"},
        "FM": {
            "code": "691",
        ...
        "FO": {"code": "298", "pattern": "(?:20|[34]\\d|8[19])\\d{4}", "mobile": "(?:[27][1-9]|5\\d|9[16])\\d{4}"},
        "FR": {
            "code": "33",
        ...
        "GF": {
            "code": "594",
            "pattern": "(?:59(?:4(?:[02-49]\\d|1[0-5]|5[6-9]|6[0-3]|80)|88\\d)|80[6-9]\\d\\d)\\d{4}",
            "mobile": "(?:694(?:[0-249]\\d|3[0-8])|7093[0-3])\\d{4}",
        },
        "GG": {"code": "44", "pattern": "1481[25-9]\\d{5}", "mobile": "7(?:(?:781|839)\\d|911[17])\\d{5}"},
        "GH": {
            "code": "233",
            ...
            "mobile": "(?:2(?:[0346-9]\\d|5[67])|5(?:[03-7]\\d|9[1-9]))\\d{6}",
        },
        "GI": {
            "code": "350",
        ...
        "GL": {"code": "299", "pattern": "(?:19|3[1-7]|[68][1-9]|70|9\\d)\\d{4}", "mobile": "[245]\\d{5}"},
        "GM": {
            "code": "220",
            "pattern": "(?:4(?:[23]\\d\\d|4(?:1[024679]|(?:4(?:[237-9]\\d|4[14-9])|8[0-389]\\d)\\d|5(?:5(?:3\\d|4[0-7])|[67]\\d\\d)))|5(?:5(?:3\\d|4[0-7])|6[67]\\d|7(?:1[04]|2[035]|3[58]|48))|8[0-389]\\d\\d)\\d{3}|44[6-9]\\d{4}",
        ...
        "GP": {
            "code": "590",
            "pattern": "(?:59(?:0(?:0[1-68]|[14][0-24-9]|2[0-68]|3[1-9]|5[3-579]|[68][0-689]|7[08]|9\\d)|87\\d)|80[6-9]\\d\\d)\\d{4}",
            "mobile": "(?:69(?:0\\d\\d|1(?:2[2-9]|3[0-5]))|7090[0-4])\\d{4}",
        },
        "GQ": {
            "code": "240",
        ...
        "GT": {"code": "502", "pattern": "[267][2-9]\\d{6}", "mobile": "(?:[3-5]\\d\\d|80[0-4])\\d{5}"},
        "GU": {
            "code": "1",
            "pattern": "671(?:2\\d\\d|3(?:00|3[39]|4[349]|55|6[26])|4(?:00|56|7[1-9]|8[02-9])|5(?:55|6[2-5]|88)|6(?:3[2-578]|4[24-9]|5[34]|78|8[235-9])|7(?:[0479]7|2[0167]|3[45]|8[7-9])|8(?:[2-57-9]8|6[478])|9(?:2[29]|6[79]|7[1279]|8[7-9]|9[16-9]))\\d{4}",
        ...
        "GW": {"code": "245", "pattern": "443\\d{6}", "mobile": "9(?:5\\d|6[569]|77)\\d{6}"},
        "GY": {
            "code": "592",
            "pattern": "(?:2(?:1[6-9]|2[0-35-9]|3[1-4]|5[3-9]|6\\d|7[0-79])|3(?:2[25-9]|3\\d)|4(?:4[0-24]|5[56])|50[0-6]|77[1-57])\\d{4}",
            "mobile": "(?:51[01]|6\\d\\d|7(?:[0-5]\\d|6[0-79]|70|8[067]))\\d{4}",
        },
        "HK": {
            "code": "852",
        ...
        "HN": {
            "code": "504",
            "pattern": "2(?:2(?:0[0-59]|1[1-9]|[23]\\d|4[02-8]|5[57]|6[2458]|7[0135689]|8[01346-9]|9[0-2])|4(?:0[578]|2[3-59]|3[13-9]|4[0-68]|5[1-3589]|80)|5(?:0[2357-9]|1[1-6]|4[03-58]|5\\d|6[014-69]|7[04]|80)|6(?:[056]\\d|17|2[067]|3[047]|4[0-378]|[78][0-8]|9[01])|7(?:0[5-79]|2[01]|6[46-9]|7[02-9]|8[034]|91)|8(?:79|8[0-357-9]|9[1-57-9]))\\d{4}",
            "mobile": "[37-9]\\d{7}",
        },
        "HR": {
            "code": "385",
        ...
        "HT": {"code": "509", "pattern": "2(?:2\\d|5[1-5]|81|9[149])\\d{5}", "mobile": "(?:[34]\\d|5[568])\\d{6}"},
        "HU": {
            "code": "36",
        ...
        "IL": {
            ...
            "mobile": "55(?:4(?:0[0-3]|10|6[015-9])|57[0-289]|8[06][0-2])\\d{4}|5(?:(?:[0-2][02-9]|[36]\\d|[49][2-9]|8[3-7])\\d|5(?:01|2\\d|3[0-3]|4[3-5]|5[0-25689]|6[6-8]|7[0-267]|8[7-9]|9[1-9]))\\d{5}",
        },
        "IM": {
            "code": "44",
        ...
        "IR": {
            "code": "98",
            "pattern": "(?:1[137]|2[13-68]|3[1458]|4[145]|5[1468]|6[16]|7[1467]|8[13467])(?:[03-57]\\d{7}|[16]\\d{3}(?:\\d{4})?|[289]\\d{3}(?:\\d(?:\\d{3})?)?)|94(?:000[09]|(?:12\\d|30[0-2])\\d|2(?:[02689]0\\d|121)|4(?:111|40\\d))\\d{4}",
        ...
        "IT": {
            ...
            "mobile": "3[2-9]\\d{7,8}|(?:31|43)\\d{8}",
        },
        "JE": {
            "code": "44",
            "pattern": "1534[0-24-8]\\d{5}",
            "mobile": "7(?:(?:(?:50|82)9|937)\\d|7(?:00[378]|97\\d))\\d{5}",
        },
        "JM": {
            "code": "1",
            "pattern": "8766060\\d{3}|(?:658(?:2(?:[5-8]\\d|9[0-46-9])|[3-9]\\d\\d)|876(?:52[35]|6(?:0[1-3579]|1[0235-9]|[23]\\d|40|5[06]|6[2-589]|7[0-25-9]|8[04]|9[4-9])|7(?:0[2-689]|[1-6]\\d|8[056]|9[45])|9(?:0[1-8]|1[02378]|[2-8]\\d|9[2-468])))\\d{4}",
        ...
        "JO": {
            ...
            "mobile": "(?:427|7(?:11|[29]\\d|[78][0-25-9]))\\d{6}",
        },
        "JP": {
            "code": "81",
        ...
        "KE": {
            ...
            "mobile": "(?:1(?:0[0-8]|[18]\\d|2[014]|30|4[0-5])|7\\d\\d)\\d{6}",
        },
        "KG": {
            "code": "996",
        ...
        "KM": {"code": "269", "pattern": "7[4-7]\\d{5}", "mobile": "[34]\\d{6}"},
        "KN": {
            "code": "1",
        ...
        "LI": {
            ...
            "mobile": "(?:6(?:(?:4[5-9]|5\\d)\\d|6(?:[024-68]\\d|1[01]|3[7-9]|7[02]))\\d|7(?:[37-9]\\d|42|56))\\d{4}",
        },
        "LK": {
            "code": "94",
        ...
        "LT": {"code": "370", "pattern": "(?:3[1478]|4[124-6]|52)\\d{6}", "mobile": "6\\d{7}"},
        "LU": {
            "code": "352",
            "pattern": "(?:35[013-9]|80[2-9]|90[89])\\d{1,8}|(?:2[2-9]|3[0-46-9]|[457]\\d|8[13-9]|9[2-579])\\d{2,9}",
            "mobile": "6(?:[26][18]|5[1568]|7[189]|81|9[128])\\d{6}",
        },
        "LV": {
            "code": "371",
            "pattern": "6\\d{7}",
        ...
        "MC": {
            ...
            "mobile": "4(?:[46]\\d|5[1-9])\\d{5}|(?:3|[67]\\d)\\d{7}",
        },
        "MD": {
            "code": "373",
        ...
        "MF": {
            "code": "590",
            "pattern": "(?:59(?:0(?:0[079]|[14]3|[27][79]|3[03-7]|5[0-268]|87)|87\\d)|80[6-9]\\d\\d)\\d{4}",
            "mobile": "(?:69(?:0\\d\\d|1(?:2[2-9]|3[0-5]))|7090[0-4])\\d{4}",
        },
        "MG": {
            "code": "261",
        ...
        "ML": {
            "code": "223",
            "pattern": "2(?:07[0-8]|12[67])\\d{4}|(?:2(?:02|1[4-689])|4(?:0[0-4]|4[1-69]))\\d{5}",
            "mobile": "2(?:0(?:01|79)|17\\d)\\d{4}|(?:5[0-3]|[679]\\d|8[2-59])\\d{6}",
        },
        "MM": {
            "code": "95",
        ...
        "MN": {
            "code": "976",
            "pattern": "[12](?:2[1-3]|(?:3[2-8]|4[2-68]|5[1-4689])\\d)\\d{5,6}|7(?:0(?:[0-5]\\d|7[078]|80)|128)\\d{4}|[12]27\\d{6}|(?:11|2[16]|5[368])\\d{6}",
        ...
        "MQ": {
            "code": "596",
            "pattern": "(?:59(?:6(?:[03-7]\\d|1[05]|2[7-9]|8[0-39]|9[04-9])|89\\d)|80[6-9]\\d\\d|9(?:477[6-9]|767[4589]))\\d{4}",
            "mobile": "(?:69[67]\\d\\d|7091[0-3])\\d{4}",
        },
        ...
        "MU": {
            "code": "230",
            "pattern": "(?:2(?:[0346-8]\\d|1[0-8])|4(?:[013568]\\d|2[0-24-8]|71|90)|54(?:[3-5]\\d|71)|6\\d\\d|8(?:14|3[129]))\\d{4}",
        ...
        "MW": {"code": "265", "pattern": "1[2-9]\\d{5}", "mobile": "111\\d{6}|(?:2[12]|31|77|[89][89])\\d{7}"},
        "MX": {
            "code": "52",
        ...
        "MZ": {"code": "258", "pattern": "2(?:[1346]\\d|5[0-2]|[78][12]|93)\\d{5}", "mobile": "8[2-9]\\d{7}"},
        "NA": {
            "code": "264",
        ...
        "NC": {"code": "687", "pattern": "(?:2[03-9]|3[0-5]|4[1-7]|88)\\d{4}", "mobile": "(?:[579]\\d|8[0-79])\\d{4}"},
        "NE": {
            "code": "227",
        ...
        "NO": {
            "code": "47",
            "pattern": "(?:2[1-4]|3[1-3578]|5[1-35-7]|6[1-46-9]|7[0-8])\\d{6}",
            "mobile": "45(?:[0-24-9]\\d|3[0-57-9])\\d{4}|(?:4[016-8]|9\\d)\\d{6}",
        },
        "NP": {
            "code": "977",
            "pattern": "(?:1[0-6]\\d|99[02-6])\\d{5}|(?:2[13-79]|3[135-8]|4[146-9]|5[135-7]|6[13-9]|7[15-9]|8[1-46-9]|9[1-7])[2-6]\\d{5}",
            "mobile": "9(?:00|6[0-3]|7[0-24-6]|8[0-24-68])\\d{7}",
        },
        "NR": {"code": "674", "pattern": "444\\d{4}", "mobile": "(?:222|55[3-9]|666|777|8\\d\\d|999)\\d{4}"},
        "NU": {"code": "683", "pattern": "[47]\\d{3}", "mobile": "(?:[56]|888[1-9])\\d{3}"},
        "NZ": {
            "code": "64",
        ...
        "OM": {
            "code": "968",
            "pattern": "2[1-6]\\d{6}",
            "mobile": "(?:1505|90[1-9]\\d)\\d{4}|(?:7[124-9]|9[1-9])\\d{6}",
        },
        "PA": {
            "code": "507",
        ...
        "PE": {
            "code": "51",
            "pattern": "(?:(?:19[02-68]|(?:4[34]|5[14])[0-8]|687)\\d|7(?:173|(?:3[0-8]|55)\\d)|8(?:10[05689]|6(?:0[06-9]|1[6-9]|29)|7(?:0[0569]|[56]0)))\\d{4}|(?:1[0-8]|4[12]|5[236]|6[1-7]|7[246]|8[2-4])\\d{6}",
            "mobile": "9\\d{8}",
        },
        "PF": {"code": "689", "pattern": "4(?:0[4-689]|9[4-68])\\d{5}", "mobile": "8[7-9]\\d{6}"},
        "PG": {
            "code": "675",
            "pattern": "(?:(?:3[0-2]|4[257]|5[34]|9[78])\\d|64[1-9]|85[02-46-9])\\d{4}",
            "mobile": "(?:7\\d|8[1-58])\\d{6}",
        },
        "PH": {
            "code": "63",
        ...
        "PL": {
            "code": "48",
            "pattern": "(?:30|47\\d\\d)\\d{5}|(?:1[2-8]|2[2-69]|3[2-4]|4[1-468]|5[24-689]|6[1-3578]|7[14-7]|8[1-79]|9[145])(?:[02-9]\\d{6}|1(?:[0-8]\\d{5}|9\\d{3}(?:\\d{2})?))",
            "mobile": "21(?:1[013-5]|2\\d|3[1-9])\\d{5}|(?:45|5[0137]|6[069]|7[2389]|88)\\d{7}",
        },
        "PM": {
            "code": "508",
            "pattern": "80[6-9]\\d{6}|(?:[236-9]\\d|4[1-35-9]|5[0-47-9])\\d{4}",
            "mobile": "708(?:4[0-5]|5[0-6])\\d{4}|(?:[236-9]\\d|4[02-489]|5[02-9])\\d{4}",
        },
        ...
        "PY": {
            "code": "595",
            "pattern": "(?:3[289]|4[246-8]|61|7[1-3]|8[1-36])\\d{5,7}|(?:2(?:[14-68]\\d|2[4-68]|7[15]|9[1-5])|3(?:18|3[167]|4[2357]|51|[67]\\d)|4(?:1\\d|3[12]|5[13]|9[1-47])|5(?:[1-4]\\d|5[02-4])|6(?:3[1-3]|44|7[1-8])|7(?:4[0-4]|5\\d|6[1-578]|75|8[0-8])|858)\\d{5,6}",
            "mobile": "9(?:51|6[129]|7[1-6]|8[1-7]|9[1-5])\\d{6}",
        },
        "QA": {"code": "974", "pattern": "4(?:(?:[014]\\d\\d|999)\\d|2022)\\d{3}", "mobile": "[35-7]\\d{7}"},
        "RE": {
            "code": "262",
            "pattern": "2631[0-6]\\d{4}|26(?:2\\d|30|88)\\d{5}",
        ...
        "RU": {
            "code": "7",
            "pattern": "(?:3(?:0[12]|36|4[1-35-79]|5[1-3]|65|8[1-58]|9[0145])|4(?:01|1[1356]|2[13467]|7[1-5]|8[1-7]|9[1-689])|8(?:1[1-8]|2[01]|3[13-6]|4[0-8]|5[15-7]|6[0-35-79]|7[1-37-9]))\\d{7}",
            "mobile": "9\\d{9}",
        },
        "RW": {"code": "250", "pattern": "(?:06|2[23568]\\d)\\d{6}", "mobile": "7[237-9]\\d{7}"},
        "SA": {
            "code": "966",
        ...
        "SC": {"code": "248", "pattern": "4[2-46]\\d{5}", "mobile": "2[125-8]\\d{5}"},
        "SD": {"code": "249", "pattern": "1(?:5\\d|8[35-7])\\d{6}", "mobile": "(?:1[0-2]|9[0-3569])\\d{7}"},
        "SE": {
            "code": "46",
        ...
        "SG": {
            ...
            "mobile": "80[1-9]\\d{5}|(?:8[1-9]|9[0-8])\\d{6}",
        },
        "SH": {"code": "290", "pattern": "2(?:[0-57-9]\\d|6[4-9])\\d\\d", "mobile": "[56]\\d{4}"},
        "SI": {
            "code": "386",
            "pattern": "(?:[1-357][2-8]|4[24-8])\\d{6}",
            "mobile": "65(?:[178]\\d|5[56]|6[01])\\d{4}|(?:[37][01]|4[013]|51|6[489])\\d{6}",
        },
        "SJ": {
            "code": "47",
            "pattern": "79\\d{6}",
        ...
        "SL": {"code": "232", "pattern": "22[2-4][2-9]\\d{4}", "mobile": "(?:25|3[0-5]|66|7\\d|8[08]|9[09])\\d{6}"},
        "SM": {"code": "378", "pattern": "0549(?:8[0157-9]|9\\d)\\d{4}", "mobile": "6[16]\\d{6}"},
        "SN": {"code": "221", "pattern": "3(?:[026]\\d|3[89])\\d{6}", "mobile": "7(?:[015-8]\\d|21|90)\\d{6}"},
        "SO": {
            "code": "252",
        ...
        "SR": {
            "code": "597",
            "pattern": "(?:2[1-3]|3[0-7]|4\\d|5[2-578])\\d{4}",
            "mobile": "(?:6[08]|7[1-7]|8[1-9])\\d{5}",
        },
        ...
        "SX": {
            "code": "1",
            "pattern": "7215(?:4[2-8]|8[39]|9[056])\\d{4}",
            "mobile": "7215(?:1[02]|2\\d|5[034679]|8[0-24-8])\\d{4}",
        },
        "SY": {
            "code": "963",
            "pattern": "(?:1(?:[1478]\\d|[2356])|21\\d|3(?:[13]\\d|4)|4[134]|5[1-3])\\d{6}|2[1-5]\\d{6}",
            "mobile": "(?:50|9[03-689])\\d{7}",
        },
        "SZ": {"code": "268", "pattern": "[23][2-5]\\d{6}", "mobile": "7[5-9]\\d{6}"},
        ...
        "TD": {
            ...
            "mobile": "(?:3[01]|[69]\\d|77|8[5-7])\\d{6}",
        },
        "TG": {
            "code": "228",
            "pattern": "2(?:2[2-7]|3[23]|4[45]|55|6[67]|77)\\d{5}",
            "mobile": "(?:7[0-389]|9[0-36-9])\\d{6}",
        },
        "TH": {
            "code": "66",
        ...
        "TR": {
            "code": "90",
            "pattern": "(?:2(?:1[26]|[28][2468]|[3-5][268]|[67][246])|3(?:[13][28]|[24-6][2468]|[78][02468]|92)|4(?:[16][246]|[23578][2468]|4[26]))\\d{7}",
            "mobile": "5(?:61(?:011|61\\d)|82[2-4]\\d\\d)\\d{4}|5(?:[03-5]\\d|1[06]|24|6[24]|7[245]|9[46])\\d{7}",
        },
        "TT": {
            "code": "1",
        ...
        "TV": {"code": "688", "pattern": "2[02-9]\\d{3}", "mobile": "(?:7[01]\\d|90)\\d{4}"},
        "TW": {
            "code": "886",
            "pattern": "(?:2[2-8]\\d|370|55[01]|7[1-9])\\d{6}|4(?:(?:0(?:0[1-9]|[2-48]\\d)|1[023]\\d)\\d{4,5}|(?:[239]\\d\\d|4(?:0[56]|12|49))\\d{5})|6(?:[01]\\d{7}|4(?:0[56]|12|24|4[09])\\d{4,5})|8(?:(?:2(?:3\\d|4[0-269]|[578]0|66)|36[24-9]|90\\d\\d)\\d{4}|4(?:0[56]|12|24|4[09])\\d{4,5})|(?:2(?:2(?:0\\d\\d|4(?:0[68]|[249]0|3[0-467]|5[0-25-9]|6[0235689]))|(?:3(?:[09]\\d|1[0-4])|(?:4\\d|5[0-49]|6[0-29]|7[0-5])\\d)\\d)|(?:(?:3[2-9]|5[2-8]|6[0-35-79]|8[7-9])\\d\\d|4(?:2(?:[089]\\d|7[1-9])|(?:3[0-4]|[78]\\d|9[01])\\d))\\d)\\d{3}",
            "mobile": "(?:40001[0-2]|9[0-8]\\d{4})\\d{3}",
        },
        "TZ": {"code": "255", "pattern": "2[2-8]\\d{7}", "mobile": "(?:6[0-35-9]|7\\d)\\d{7}"},
        "UA": {
            "code": "380",
            "pattern": "(?:3[1-8]|4[13-8]|5[1-7]|6[12459])\\d{7}",
            "mobile": "790\\d{6}|(?:39|50|6[36-8]|7[1-357]|9[1-9])\\d{7}",
        },
        "UG": {
            "code": "256",
            "pattern": "20(?:(?:24[09]|30[67])\\d|6(?:00[0-2]|30[0-4]))\\d{3}|(?:20(?:[017]\\d|2[5-9]|3[1-4]|5[0-4]|6[15-9])|[34]\\d{3})\\d{5}",
            "mobile": "7(?:28|34)0\\d{5}|7(?:[014-8]\\d|2[01467]|3[0167]|9[0-589])\\d{6}",
        },
        "US": {
            "code": "1",
        ...
        "UZ": {
            "code": "998",
            "pattern": "(?:55\\d\\d|6(?:1(?:22|3[124]|4[1-4]|5[1-3578]|64)|2(?:22|3[0-57-9]|41)|5(?:22|3[3-7]|5[024-8])|[69]\\d\\d|7(?:[23]\\d|7[69]))|7(?:[168]\\d\\d|2(?:22|3[13-57-9]|4[1-3579]|5[14])|3(?:2\\d|3[1578]|4[1-35-7]|5[1-57]|61)|4(?:2\\d|3[1-579]|7[1-79])|5(?:22|5[1-9]|6[1457])|9(?:22|5[1-9])))\\d{5}",
        ...
        "VA": {"code": "39", "pattern": "06698\\d{1,6}", "mobile": "3[1-9]\\d{8}|3[2-9]\\d{7}"},
        "VC": {
            "code": "1",
        ...
        "VU": {
            ...
            "mobile": "(?:[58]\\d|7[0-7])\\d{5}",
        },
        "WF": {"code": "681", "pattern": "72\\d{4}", "mobile": "(?:72|8[23])\\d{4}"},
        "WS": {
            "code": "685",
            "pattern": "6[1-9]\\d{3}|(?:[2-5]|60)\\d{4}",
            "mobile": "(?:7[1-35-8]|8(?:[3-7]|9\\d{3}))\\d{5}",
        },
        "XK": {"code": "383", "pattern": "38\\d{6,10}|(?:2[89]|39)(?:0\\d{5,6}|[1-9]\\d{5})", "mobile": "4[3-9]\\d{6}"},
        "YE": {
            "code": "967",
        ...
        "YT": {
            "code": "262",
            "pattern": "26(?:89\\d|9(?:0[0-467]|15|5[0-4]|6\\d|[78]0))\\d{4}",
        ...
        "ZM": {"code": "260", "pattern": "21[1-8]\\d{6}", "mobile": "(?:[59][5-8]|7[5-9])\\d{7}"},
        "ZW": {
            "code": "263",
            "pattern": "(?:2(?:(?:(?:02[014]|72[03])\\d|48)\\d|2(?:[278]\\d|92)|583)|(?:37[56]|6[78]21\\d)\\d|5(?:483|525\\d\\d))\\d{3}|(?:2(?:0\\d|7[1-7])|(?:55|6[78])\\d)\\d{4}|(?:13|2(?:(?:42|9\\d)\\d|[56]20)|3(?:123|92\\d)|(?:4|542)\\d|6(?:[16]21|52[013])|8(?:[1349]28|523)|9[2-9])\\d{5}",
            "mobile": "7(?:[1278]\\d|3[1-9]|9[01])\\d{6}",
        },
    },
}
