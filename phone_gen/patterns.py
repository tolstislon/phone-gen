# -*- coding: utf-8 -*-
"""
Auto-generated file 2022-03-14 14:26:55 UTC
Resource: https://github.com/google/libphonenumber v8.12.45
"""


PATTERNS = {
    "info": "libphonenumber v8.12.45",
    "data": {
        "AC": {
            "code": "247",
            "pattern": "((6[2-467][\\d]{3}))",
        ...
        "JM": {
            "code": "1",
            "pattern": "((8766060[\\d]{3})|((658(2([0-8][\\d])|(9[0-46-9]))|([3-9][\\d][\\d]))|(876(52[35])|(6(0[1-3579])|(1[0237-9])|([23][\\d])|(40)|(5[06])|(6[2-589])|(7[0257])|(8[04])|(9[4-9]))|(7(0[2-689])|([1-6][\\d])|(8[056])|(9[45]))|(9(0[1-8])|(1[02378])|([2-8][\\d])|(9[2-468])))[\\d]{4}))",
